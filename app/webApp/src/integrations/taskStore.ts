...
export const taskActions: TaskActions = {
  ...
  keepLocalProject: store.keepLocalProject.bind(store),
  useRemoteProject: store.useRemoteProject.bind(store),
  mergeProjectConflict: store.mergeProjectConflict.bind(store),
